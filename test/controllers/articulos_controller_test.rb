...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { contenido: @articulo.contenido, escritor: @articulo.escritor, imagen: @articulo.imagen, noticia: @articulo.noticia, titulo: @articulo.titulo }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { contenido: @articulo.contenido, escritor: @articulo.escritor, imagen: @articulo.imagen, noticia: @articulo.noticia, titulo: @articulo.titulo }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
